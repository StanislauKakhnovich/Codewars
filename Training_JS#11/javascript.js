...
// You need traverse dolls by using for loop. If element is "Hello Kitty" or "Barbie doll", you should push it to a bag(bag is 
// an array, I've defined in the function); if it's other strings, we should use continue skip it.
